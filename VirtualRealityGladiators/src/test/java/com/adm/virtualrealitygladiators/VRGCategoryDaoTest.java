 ...
 * @author adam-
 */
public class VRGCategoryDaoTest {
    ...
    public void testRemoveCategory() {
        ...
        Category fromDao = categoryDao.getCategoryById(category.getCategoryId());
        assertEquals(category, fromDao);
        categoryDao.removeCategory(category.getCategoryId());
    ...
    public void testGetAllCategories() {
        ...
        assertTrue(categoryDao.getAllCategories().contains(category));
        assertTrue(categoryDao.getAllCategories().contains(cat2));
    }
    
    @Test
    public void testGetCategoriesByBlog() {
        ...
        assertEquals(1, categoryDao.getCategoriesByBlog(blog).size());
        assertTrue(categoryDao.getCategoriesByBlog(blog).contains(cat));
        assertFalse(categoryDao.getCategoriesByBlog(blog).contains(cat2));
    }
}
