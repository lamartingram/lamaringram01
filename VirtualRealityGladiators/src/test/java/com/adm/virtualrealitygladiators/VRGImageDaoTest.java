...
public class VRGImageDaoTest {
    ...
    public void testRemoveImage() {
        ...
        Image fromDao = imageDao.getImageById(image.getImageId());
        assertEquals(image, fromDao);
        imageDao.removeImage(image.getImageId(), blog.getBlogId());
    ...
    public void testUpdateImage() {
        ...
        image2.setImageId(image.getImageId());
        imageDao.updateImage(image2);
        fromDao = imageDao.getImageById(image.getImageId());
        assertEquals(fromDao, image2);
        assertNotEquals(fromDao, image);
    }
    ...
    public void testGetAllImages() {
        ...
        assertTrue(imageDao.getAllImages().contains(image));
        Image image2 = imageArray[1];
        imageDao.addImage(image2);
        assertEquals(2, imageDao.getAllImages().size());
        assertTrue(imageDao.getAllImages().contains(image2));
        assertTrue(imageDao.getAllImages().contains(image));
    }
