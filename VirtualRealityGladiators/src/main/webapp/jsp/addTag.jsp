    ...
    <body background="${pageContext.request.contextPath}/img/gears_standin.jpg" style="background-size: cover">
        <div class="container-fluid">
            ...
            <div class="col-md-offset-3 col-md-6">
                <h1 style="text-align: center">Add Tag</h1>
                <form class="form-horizontal" role="form" method="POST" action="addTag">
                    <div class="form-group">
                        <label for="addTagName" class="control-label col-md-4">Name:</label>
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="addTagName" placeholder="Hashtag..." required/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-offset-4">
                            <input type="submit" value="Create Tag" class="btn btn-warning"/>
                        </div>
                    </div>
                </form>
            </div>
